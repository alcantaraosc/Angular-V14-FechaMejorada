...
import { AccesodatossecurityrolesService } from 'src/app/_services/accesodatossecurityroles.service';
...
export class RolesfuncionesComponent implements OnInit {
  ...
  constructor(private accesoSecurityFunciones: AccesodatossecurityfuncionesService,
    private accesoSecurityRoles: AccesodatossecurityrolesService,
    private notificationService: NotificationService,
    private emitirDatosService: AppService,
    private enviaDatos: ComunicacionService) { }
  ...
  drop(event: CdkDragDrop<string[]>) {
    ...
    //enviar el arreglo rolesAsignado[] al componente: [app/_components/security/funciones/modalfunciones/modalfunciones.component] por servicio     
    //se usa servicio
    this.enviaDatos.EviarDatosModalRolesFunciones(this.listAsignada, this.ventanaDelComponenteaMostrar);
  }
  ...
  onListarRoles() {
    //suscribirse 
    this.accesoSecurityRoles.getListarRolActivo(true).subscribe((response: responseModel) => {
  ...
  onListarFunciones() {
    //suscribirse 
    this.accesoSecurityFunciones.getListarFuncionesActivo(true).subscribe((response: responseModel) => {
